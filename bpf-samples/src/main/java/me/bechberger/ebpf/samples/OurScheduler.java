...
public abstract class OurScheduler extends BPFProgram implements Scheduler, Runnable {
    ...
    @BPFMapDefinition(maxEntries = 100000)
    BPFLRUHashMap<@Unsigned Integer, @Unsigned Long> unused_vtime;
    ...
    public static void main(String[] args) {
        try (var program = BPFProgram.load(OurScheduler.class)) {
